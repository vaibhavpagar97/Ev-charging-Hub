<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login1.aspx.cs" Inherits="Registration_form.WebForm3" %>
...
<body>
    ...
    <table style="margin:auto;border:1px solid white">
        <tr>
            ...
            <td>
                <asp:TextBox ID="vendor_email" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="Label2" runat="server" Text="password"></asp:Label></td>
            <td>
                <asp:TextBox ID="vendor_password" runat="server" TextMode="Password" BackColor="White"></asp:TextBox></td>
        </tr>
        <tr>
            <td>
                </td>
            <td>
                <asp:Button class="button" ID="btnLogin1" runat="server" Text="Login" OnClick="btnLogin1_Click" BorderColor="#CCCCFF" /></td>
        </tr>
        <tr>
            <td></td>
            <td>
