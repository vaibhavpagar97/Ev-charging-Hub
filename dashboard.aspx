<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dashboard.aspx.cs" Inherits="Registration_form.WebForm2" %>
...
<body>
    <div class="navbar">
     ...
     <div class="user-info"><h1>User Dashboard</h1></div>
...
<div class="user-info">
    ...
    <p> user ID: <asp:Literal ID="UserIdLiteral" runat="server" /></p>
...
<!-- You can add more Literal controls for other user details if needed -->
    ...
    <!-- Button links as buttons -->
            ...
            <a href="bookingmap.aspx" class="green-button">Search Station</a>
            <a href="userbookings.aspx" class="green-button">User Bookings</a>
            <a href="Paymenthistory.aspx" class="green-button">Payment History</a>
            <a href="Home.html" class="green-button">Go to Home</a>
